 ...
 * index typically provides a primary filter for range rectangle queries. A secondary filter is
 * required to test for exact intersection. The secondary filter may consist of other kinds of
 * tests, such as testing other spatial relationships.
 *
 * @version 1.7
 */
