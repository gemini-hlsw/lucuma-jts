...
public class TriangleTest extends TestCase
{
      ...
      throws Exception
  {
    ...
    Coordinate centroid = Triangle$.MODULE$.centroid(pt[0], pt[1], pt[2]);
      ...
      throws Exception
  {
    ...
    Coordinate circumcentre = Triangle$.MODULE$.circumcentre(pt[0], pt[1], pt[2]);
      ...
      throws Exception
  {
    ...
    double length = Triangle$.MODULE$.longestSideLength(pt[0], pt[1], pt[2]);
